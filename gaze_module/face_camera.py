...
class FaceParts:
    ...
    def angle_to_vector_others(self) -> None:
...
class Face(FaceParts):
    def __init__(self, bbox: np.ndarray, landmarks: np.ndarray):
        ...
        self.nose_pos: Optional[np.ndarray] = None
        self.chin_pos: Optional[np.ndarray] = None
...
class FaceModel:
    ...
    def compute_face_eye_centers(self, face: Face, mode: str) -> None:
        ...
        face.chin_pos = face.model3d[self.CHIN_INDEX]
        face.nose_pos = face.model3d[self.NOSE_INDEX]
